...
разработать утилиту для обнаружения файлов-дубликатов. <br>
...
Разные группы разделяются пустой строкой. <br>
...
H("\n\0\0\0\0") == E
```
может быть представлен в виде последовательности ADE. <br>
...
пропуска существующих дубликатов. <br>
